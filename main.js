...
function myKeyDown(e)
{
		...
		if(ballY >=450)
		 {
			...
			console.log("Quando a tecla direcional cima é pressionada, X = " + ball_y + " , X - "+ball_x);
			canvas.remove(ballObj);
			newImage();
		 }
	...
	function right()
	{
		if(ballX <=1050)
		{
			...
			ballX = ballX + blockImageWidth;
			console.log("Largura  da imagem do bloco - " + block_image_width);
			console.log("Quando a tecla direcional direito é pressionada, X = " + ball_x + " , Y - "+ball_y);
			canvas.remove(ballObj);
			newImage();
		}
	}
